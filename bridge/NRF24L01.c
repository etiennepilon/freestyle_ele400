/*
*	Auteur : Christin Daignault-St-Arnaud
*	mail: Christian.dsa@gmail.com
*	date : 15/03/2016
*/
...
void NRF24l01_Initialization(SPI_HandleTypeDef* hspi, uint8_t Mode){
	...
	NRF24L01_Enable_AA(hspi,TRUE,FALSE,FALSE,FALSE,FALSE,FALSE);
	...
	NRF24L01_Enable_RXADDR(hspi,TRUE,FALSE,FALSE,FALSE,FALSE,FALSE);
